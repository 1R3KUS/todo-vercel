  ...
  return (
    <div>
      ...
      <div className="task-creator">
        <input type="text" value={inputText} onChange={(e) => setInputText(e.target.value)} placeholder="Введите текст задачи..."/>
        <button className='task-creator__button' onClick={() => {
            addTask(inputText)
            setInputText('')
          }}>
          <i>
